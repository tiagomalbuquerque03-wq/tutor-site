export const content = {
  pt: {
    ...
    cta: {
      headline: "Disponível agora no iPhone",
      sub: "A Clari já está no iOS. No Android, as 20 primeiras inscrições ganham 6 meses de Premium grátis.",
      iosLabel: "iPhone",
      androidLabel: "Android",
      iosScan: "Escaneie o QR code para baixar",
      iosAppStore: "Disponível na App Store",
      iosUrl: "https://apps.apple.com/br/app/clari/id6769223287",
      emailPlaceholder: "Seu WhatsApp (ex: 21 99999-9999)",
      submit: "Quero acesso antecipado",
      successTitle: "Anotado!",
      successSub: "Você está na lista. Vamos te avisar pelo WhatsApp quando liberar. As 20 primeiras vagas ganham 6 meses grátis.",
      androidComingSoon: "🔒 Apenas 20 vagas — 6 meses de Premium grátis",
      errorMsg: "Algo deu errado. Tente de novo.",
    },
    footer: {
      tagline: "IA por voz que organiza o estudo a partir do material real do aluno.",
      links: [
        { label: "Termos de uso", href: "#" },
        { label: "Privacidade", href: "#" },
        { label: "Contato", href: "mailto:contato@clari.online" },
      ],
  ...
  en: {
    ...
    cta: {
      headline: "Now available on iPhone",
      sub: "Clari is live on iOS. On Android, the first 20 sign-ups get 6 months of Premium free.",
      iosLabel: "iPhone",
      androidLabel: "Android",
      iosScan: "Scan the QR code to download",
      iosAppStore: "Available on the App Store",
      iosUrl: "https://apps.apple.com/ca/app/clari-tutor/id6769223287",
      emailPlaceholder: "Your WhatsApp (e.g. 21 99999-9999)",
      submit: "Get early access",
      successTitle: "You're in!",
      successSub: "We'll message you on WhatsApp when Android launches. First 20 sign-ups get 6 months free.",
      androidComingSoon: "🔒 Only 20 spots — 6 months of Premium free",
      errorMsg: "Something went wrong. Please try again.",
    },
    footer: {
      tagline: "AI mentor for students aged 13–18.",
      links: [
        { label: "Terms of use", href: "#" },
        { label: "Privacy", href: "#" },
        { label: "Contact", href: "mailto:contact@clari.online" },
      ],
