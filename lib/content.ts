export const content = {
  pt: {
    ...
    features: {
      ...
      items: [
        ...
        {
          tag: "04",
          title: "Alinhado ao ENEM e vestibular",
          desc: "31 matérias canônicas, 280 tópicos mapeados. Exercícios no estilo das provas que realmente importam.",
    ...
    footer: {
      tagline: "O tutor de IA para alunos de 13–18 anos.",
      links: [
  ...
  en: {
    ...
    cta: {
      ...
      sub: "Clari is coming soon. Pick your platform and leave your email — we'll notify you when it's ready.",
      iosLabel: "iPhone",
      androidLabel: "Android",
      emailPlaceholder: "your@email.com",
      submit: "Notify me",
      successTitle: "You're in!",
      successSub: "We'll let you know as soon as Clari is available.",
      note: "iOS and Android launch on different dates.",
