        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          >
            ...
            <div className="text-left">
              <p className="text-[10px] leading-none mb-0.5" style={{ color: "var(--text-muted)" }}>{c.androidPrefix}</p>
              <p className="font-semibold text-sm leading-none" style={{ fontFamily: "var(--font-space-grotesk)" }}>{c.android}</p>
            </div>
          </a>
          ...
          >
            ...
            <div className="text-left">
              <p className="text-[10px] leading-none mb-0.5" style={{ color: "var(--text-muted)" }}>{c.iosPrefix}</p>
              <p className="font-semibold text-sm leading-none" style={{ fontFamily: "var(--font-space-grotesk)" }}>{c.ios}</p>
            </div>
          </a>
        </div>
